...
public class TestData {
    ...
    public static Object[][] LangRegisterPageDataProvider() {
        ...
        return new Object[][]{
                {0,  "Registrieren","https://accounts.dev.swisscows.com/register?culture=de","Registrieren"},
                {1,  "Registrarse","https://accounts.dev.swisscows.com/register?culture=es","Registrarse"},
                {2,  "S'inscrire","https://accounts.dev.swisscows.com/register?culture=fr","S'inscrire"},
                {3,  "Registrarsi","https://accounts.dev.swisscows.com/register?culture=it","Registrarsi"},
                {4,  "Reģistrēties","https://accounts.dev.swisscows.com/register?culture=lv","Reģistrēties"},
                {5,  "Registreren","https://accounts.dev.swisscows.com/register?culture=nl","Registreren"},
                {6,  "Regisztráció","https://accounts.dev.swisscows.com/register?culture=hu","Regisztráció"},
                {7,  "Registrar","https://accounts.dev.swisscows.com/register?culture=pt", "Registrar"},
                {8,  "Регистрация","https://accounts.dev.swisscows.com/register?culture=ru","Регистрация"},
                {9,  "Реєстрація","https://accounts.dev.swisscows.com/register?culture=uk","Реєстрація"},
